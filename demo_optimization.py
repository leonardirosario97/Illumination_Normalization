...
def robustness():
    ...
    for file in os.listdir(dataset_path):
            if(int(file[2])!=2):
                ...
                #file_path_1_save = file_path_1[:-4]+"_save"+file_path_1[-4:] 
                #file_path_2_save = file_path_2[:-4]+"_save"+file_path_2[-4:] 
                #cv2.imwrite(file_path_1_save,im1_preproc)
                #cv2.imwrite(file_path_2_save,im2_preproc)
...
robustness()
#videoconversion(pathVideo="./Video/ball_1.mp4",pathSave='./Video/ball_1_edit.mp4')